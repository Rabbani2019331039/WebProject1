<%-- 
    Document   : addCourse
    Created on : May 20, 2023, 8:41:22 PM
    Author     : Alion Leo
--%>
<%@page import ="servlet.*" %>
<%@page import ="mod.*" %>
   ...
   <main>
      <div class="main-container">
         ...
         <div class="listView glass-morphism">
            <div class="list-heading">
               <div class="heading-id">Add New Course</div>
            </div>
            <div class="list-content">
               <div class="new-course-form">
                  <form action="/manage/addcourse" method="POST">
                     <div class="input-box">
                    ...
                    <div class="input-box">
                        <input type="text" required name="course_info">
